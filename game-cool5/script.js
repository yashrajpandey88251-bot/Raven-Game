...
class Raven {
    constructor() {
        ...
        this.directionX = Math.random() * 14 + 3;
    ...
    update(deltaTime) {
        if (canvas.height < this.y + this.height || this.y < 0) {
...
function drawGameOver(){
    ...
    ctx.fillStyle = "black";
    ctx.fillText("GAME OVER BABY, YOUR SCORE IS : "+score, canvas.width/2, canvas.height/2);
    ctx.fillStyle = "white";
    ctx.fillText("GAME OVER BABY, YOUR SCORE IS : "+score, canvas.width/2 + 5, canvas.height/2 + 5);
}
